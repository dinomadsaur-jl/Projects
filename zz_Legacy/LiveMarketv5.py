...
SILVER_SCALE_FACTOR = 80  # ← current market (Feb 2026) suggests 70–90; tune after run
...
# ────────────────────────────────────────────────
# SMA Reversal Detection (from your Matplotlib version – raw price labels)
# ────────────────────────────────────────────────
    ...
    fig.update_layout(
        title={
            'text': f"<b>Market Analysis (5yr) - Weekly SMA Direction Changes</b><br>"
                    f"<span style='font-size:0.9em;'>Gold ${last_gold:,.0f} | Silver ${last_silver:,.2f} | "
